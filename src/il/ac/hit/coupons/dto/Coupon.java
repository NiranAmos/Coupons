...
public class Coupon
{
	...
	public String toHtml() {
		...
		output.append("<html><h2><i>Name : " + getName() + "</h2></i></html>");
		output.append("<html>Description : " + getDescription() + "<br></html>");
		output.append("<html>Category : " + getCouponType() + "<br></html>");
		output.append("<html>Available units : " + getAvailableAmount() + "<br></html>");
		output.append("<html>Expire time : " + getExpireTime() + "<br></html>");
		output.append("<html>Expire date : " + getExpireDate() + "<br></html>");
		output.append("<html>Discount : " + getDiscountPercentage() + "%" + "<br></html>");
		output.append("<html>Original price : " + getOriginalPrice() + "<br></html>");
		output.append("<html>Price after discount : " + getPriceAfterDiscount() + "<br></html>");
		output.append("<html>Location  : " + getLocation() + "<br><br><br></html>");
