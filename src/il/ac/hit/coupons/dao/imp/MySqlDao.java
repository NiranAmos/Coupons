...
public class MySqlDao implements IDao
{
	...
	/**
	 * Reference variable that holds the group of sessions to be connected to the data base
	 */
	private SessionFactory factory = new AnnotationConfiguration().configure().buildSessionFactory();
	/**
	 * current session that execute queries
	 */
	private Session session = null;
	/**
	 * used to execute add, update and remove queries
	 */
