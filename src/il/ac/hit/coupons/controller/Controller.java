...
public class Controller extends HttpServlet {
	...
	/**
	 * singleton instance of MySqlDao to access data from MySql database 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if (path.endsWith("/loginform"))  // added else if
		{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			adminAuthentication(request, response, out);
		}
	...
	private void sortCouponsByDistance(HttpServletRequest request,HttpServletResponse response) throws CouponException, ParseException {
		...
		try
		{
			latUser = Double.parseDouble(request.getParameter("lat"));
			lonUser = Double.parseDouble(request.getParameter("lang"));
		}
		catch (NumberFormatException e)
		{
			request.getSession().setAttribute("errorMessage", "You need to enter a location!");
			request.getSession().setAttribute("gotopage", "../index.jsp");
		}
	 ...
	 * @param out
	 */
	private void adminAuthentication(HttpServletRequest request, HttpServletResponse response, PrintWriter out) {
