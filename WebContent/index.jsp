...
<ul class="nav nav-tabs">
 <li role="presentation" class="active"><a href="#">Home</a></li>
  <li role="presentation"><a href="Coupons/loginform">Login to admin menu</a></li>
  <li role="presentation"><a href="Coupons/myfavoritecoupons">My favorites list</a></li>
  <form name=category action="Coupons/index" method="get">
		<select name=typeofcoupons>
	...
	<div class="control-group">
		<form name=userLocation action="Coupons/userlocation" method="post">
			...
			<button type="submit">Sort by your location</button>
			<br /> <br>
	...
	<%!
		...
		try {
			...
			out2.println("<form action ='Coupons/addtofavorites?id=" + coupon.getId() + "' method='post'>");
			out2.println("<input type='submit' value='Add this coupon to your favorite coupons'></form><br>");
		}
