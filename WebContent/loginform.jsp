...
<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="http://bootsnipp.com/css/bootsnipp.min.css?ver=70eabcd8097cd299e1ba8efe436992b7">
<style>    
    form {
    position: fixed;
    left: 1000px;
...
<% isHidden = request.getSession().getAttribute("isValidUser").toString(); %>
 ...
 <div class="container">
	<div class="row" style="margin-top:60px;">
		<div class="col-md-4 col-md-offset-4">
			<form action="adminmenu" method="POST" accept-charset="UTF-8" role="form" id="loginform" class="form-signin"><input name="_token" type="hidden" value="IbktGMhrnupuXdIMeJ07XlyAcZBr66O7OFUuIoKi">
				<fieldset>
			  		<h3 class="sign-up-title" style="color:dimgray;">Welcome back! Please sign in</h3>
			  		<hr class="colorgraph">
				    <input class="form-control email-title" placeholder="User Name" name="userName" type="">
