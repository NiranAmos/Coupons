...
<%@ page import="il.ac.hit.coupons.dto.FavoritesList"%>
...
<%!
	...
	Iterator<Coupon> i;
	Coupon coupon;
	FavoritesList myFavoritesList = null;
	%>
...
if(request.getSession().getAttribute("myFavoritesList") == null)
{
	...
	myFavoritesList = (FavoritesList) request.getSession().getAttribute("myFavoritesList");
    try {
